...
boom = pygame.mixer.Sound('assets/audio/bombsound.ogg')
shout = pygame.mixer.Sound('assets/audio/shout.ogg')
font = pygame.font.Font("assets/fonts/BASKVILL.ttf", 48)
fonter = pygame.font.Font("assets/fonts/BASKVILL.ttf", 36)
mfont = pygame.font.Font("assets/fonts/BASKVILL.ttf",18)
